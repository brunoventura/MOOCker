...
var _CoursesContainer = require('./components/CoursesContainer');

var _CoursesContainer2 = _interopRequireDefault(_CoursesContainer);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _reactDom.render)(_react2.default.createElement(_CoursesContainer2.default, null), document.getElementById('root'));

},{"./components/CoursesContainer":162,"decko":1,"react":159,"react-dom":30}],162:[function(require,module,exports){
'use strict';
...
var CoursesContainer = function (_Component) {
    _inherits(CoursesContainer, _Component);

    function CoursesContainer() {
        _classCallCheck(this, CoursesContainer);

        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(CoursesContainer).call(this));
    ...
    _createClass(CoursesContainer, [{
        ...
        value: function componentWillMount() {
            ...
            fetch('../courses.json').then(function (response) {
                ...
                return _this2.setState({ courses: responseData });
            }).catch(function (err) {
        ...
        value: function render() {
            var courseNames = this.state.courses.map(function (course) {
                return _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'div',
                        { className: 'thumbnail' },
                        _react2.default.createElement('div', { className: 'image-container', style: { backgroundImage: 'url(' + course.image + ')' } }),
                        _react2.default.createElement(
                            'div',
                            { className: 'caption' },
                            _react2.default.createElement(
...
exports.default = CoursesContainer;

},{"react":159,"whatwg-fetch":160}]},{},[161]);
